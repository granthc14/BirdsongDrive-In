...
export default class CheckoutScreen extends Component {
    ...
    async getOrderNumberAndColor() {
        ...
        let params = '?screenNo={0}&carMake={1}&carModel={2}&carColor={3}&cashOrCard={4}&orderItems={5}&cost={6}&extras={7}'.format(order.screenNo, order.carMake, order.carModel, order.carColor, order.cashOrCard, JSON.stringify(order.items), order.cost, JSON.stringify(order.extras));
